...
$LLL = 'LLL:EXT:plugsy/Resources/Private/Language/locallang_be.xlf';
...
return [
    'ctrl' => [
        ...
        'iconfile' => 'EXT:plugsy/Resources/Public/Icons/Extension.svg',
        'hideTable' => true,
        'enablecolumns' => [
            'disabled' => 'hidden',
            'starttime' => 'starttime',
    ...
    'columns' => [
        'api_endpoint' => [
            'exclude' => true,
            'label' => $LLL . ':tx_plugsy_api_endpoint',
            'config' => [
                'type' => 'select',
        ...
        'source' => [
            ...
            'config' => [
                ...
                'itemsProcFunc' => TYPO3Incubator\Plugsy\Backend\UserFunctions\SelectAPIResponseKeys::class . '->selectAPIResponseKeys',
                'behaviour' => [
